      ...
      <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="w-32 rounded-lg border border-teal-300 bg-white px-3 py-1.5 font-mono text-sm font-bold text-teal-900 outline-none focus:ring-2 focus:ring-teal-500 dark:border-teal-700 dark:bg-slate-900 dark:text-teal-100"
              />
            </div>
          </div>
        </div>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-1 rounded-lg bg-teal-50 px-2.5 py-1 text-xs font-semibold text-teal-700 hover:bg-teal-100 dark:bg-teal-950/60 dark:text-teal-300"
            >
          ...
          <div className="space-y-2 max-h-72 overflow-y-auto pr-1">
            {lineItems.map((item, idx) => (
              <div
                key={idx}
                className="grid grid-cols-12 gap-2 items-center rounded-lg border border-slate-200 bg-slate-50 p-2 text-xs dark:border-slate-800 dark:bg-slate-900"
              >
                ...
                <div className="col-span-4 space-y-1">
                  <select
                    ...
                    className="w-full rounded-md border border-slate-300 px-2 py-1 text-xs text-slate-900 outline-none dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
                  >
                ...
                <div className="col-span-2">
                  <label className="text-[10px] text-slate-400 block mb-0.5">Pcs</label>
                  <input
                    type="number"
                    min="0"
                    ...
                    placeholder="Pcs"
                    className="w-full rounded-md border border-slate-300 px-2 py-1 text-xs font-mono text-slate-900 outline-none dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
                  />
                </div>
                ...
                {/* Price / Kg */}
                <div className="col-span-2">
                  <label className="text-[10px] text-slate-400 block mb-0.5">Rate (₹/kg)</label>
                  <input
                    type="number"
                    step="0.01"
                    min="0"
                ...
                <div className="col-span-2 flex items-center justify-between pl-1">
                  ...
                  <button
                    ...
                    className="rounded p-1 text-slate-400 hover:bg-red-50 hover:text-red-600 disabled:opacity-30 dark:hover:bg-red-950/50"
                  >
        ...
        <div className="flex justify-end gap-2 pt-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg bg-teal-600 px-5 py-2 text-sm font-bold text-white shadow-sm hover:bg-teal-700 disabled:opacity-50"
          >
